...
CreateLineDialog::CreateLineDialog(const Glib::ustring & title) :
    ...
    m_z1Label(Gtk::manage(new Gtk::Label("z1: "))),
    m_z2Label(Gtk::manage(new Gtk::Label("z2: "))),
    ...
    m_z1Entry(Gtk::manage(new Gtk::Entry())),
    m_z2Entry(Gtk::manage(new Gtk::Entry()))
{
    set_resizable(false);
    set_border_width(10);
    ...
    m_z1Entry->set_width_chars(6);
    m_z2Entry->set_width_chars(6);
    ...
    coord1_hbox->pack_start(*m_z1Label, Gtk::PACK_EXPAND_PADDING, 0);
    coord1_hbox->pack_start(*m_z1Entry, Gtk::PACK_SHRINK, 0);
    ...
    coord2_hbox->pack_start(*m_z2Label, Gtk::PACK_EXPAND_PADDING, 0);
    coord2_hbox->pack_start(*m_z2Entry, Gtk::PACK_SHRINK, 0);
...
void CreateLineDialog::on_my_response(int response_id) {
    switch (response_id) {
        case Gtk::RESPONSE_OK:
        {
            ...
            std::stringstream sX1, sY1, sZ1, sX2, sY2, sZ2;
            ...
            if (!name.empty() &&
                    ...
                    && sX2.str().size() != 0 && sY2.str().size() != 0 && sZ2.str().size() != 0) {
