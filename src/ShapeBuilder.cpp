...
void ShapeBuilder::add_point(const double x, const double y, const double z) {
    if (m_name.empty()) {
        m_name = "Nameless";
    }
...
void ShapeBuilder::add_point(const std::string &name, const double x, const double y, const double z) {
